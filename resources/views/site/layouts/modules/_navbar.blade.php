    ...
    <div class="container">
        <div class="row d-flex flex-wrap">
            <div class="col-lg-3 col-md-6 header__phones">
                <div class="header__phone-wrapper position-relative">
                    <a class="header__link" href="tel:+79057042131">
                        <div class="header__aria-animation js-animation-replace-1"></div>
                        <div class="header__phone-label">
                            Запись на обучение
                        </div>
                        <div class="header__phone">
                        <p class="header__phone link-span-black-red">+<span
                                    class="border-bottom-dashed">7 905 704-21-31</span></p>
                        </div>
                    </a>
                </div>

                <div class="header__phone-wrapper position-relative">
                    <a class="header__link" href="tel:+79851276390">
                        <div class="header__aria-animation js-animation-replace-2"></div>
                        <div class="header__phone-label">
                            Запись моделью
                        </div>
                        <div class="header__phone">
                            <p class="header__phone link-span-black-red">+<span
                                        class="border-bottom-dashed">7 985 127-63-90</span></p>
                        </div>
                    </a>
                </div>
            </div>

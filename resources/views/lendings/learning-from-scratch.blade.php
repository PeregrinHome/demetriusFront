...
<section id="js-lending">
    ...
    <section class="pt-5 pb-5">
        ...
        <div class="container-fluid container-primary pl-4">
            <div class="row no-gutters">
                <div class="col-12 col-md-5 pl-3">
                    <div class="pl-5 mb-3 t__box-line-left t__box-line-left-fix">
                        <p class="h2">ЖЕНСКИЙ МАСТЕР</p>
                        <p class="mb-0">Женские стрижки, колористка, укладки,
                            трихология и массаж</p>
                    </div>
                    <p>
                        Интенсивный тренинг подойдет для тех,
                        кто уже работает в салоне красоты
                        или только желает стать парикмахером.
                    </p>
                    <div class="d-flex small t__text-red align-items-center">
                ...
                <div class="col-12 col-md-7 pl-2">
